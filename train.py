...
if 1:
    ...
    # Dataset
    # Evan: Replace tfrecord_dir path with the path to your tfrecord dataset
    desc += '-pattern';     dataset = EasyDict(tfrecord_dir='e:/Documents/Development/Datasets/Patterns/Preprocessed/tfrecords');                 train.mirror_augment = True
